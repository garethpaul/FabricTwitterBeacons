...
expect("https://twitter.com/", accepted: false, "host root")
expect("https://twitter.com/login", accepted: false, "non-status path")
expect("https://twitter.com/example/status/not-a-number", accepted: false, "non-numeric status ID")
expect("https://twitter.com/example/status/1/extra", accepted: false, "extra status path")
expect("https://twitter.com/bad-user/status/1", accepted: false, "invalid username punctuation")
expect("https://twitter.com/abcdefghijklmnop/status/1", accepted: false, "oversized username")
expect("https://twitter.com/é/status/1", accepted: false, "non-ASCII username")
