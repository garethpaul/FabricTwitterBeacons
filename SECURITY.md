...
Orphaned alternate beacon controllers must remain absent so obsolete always-on
authorization or unmanaged ranging examples cannot re-enter the app target.
